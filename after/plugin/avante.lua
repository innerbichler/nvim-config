...
M._defaults = {
	debug = false,
	---@alias Provider "gemini" | "openai" | "azure" | "gemini" | "vertex" | "cohere" | "copilot" | string
	...
	windows = {
		...
		width = 100, -- default % based on available width in vertical layout
